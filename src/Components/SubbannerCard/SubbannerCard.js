...
const SubbannerCard = ({ subbanner }) => {
  return (
    <div className="flex flex-col  p-2 justify-items-center	mt-10 ">
      ...
      <div className="font-medium text-lg text-[#5C5C5C] mx-auto text-center leading-5	mt-8 min-h-[50px]">
        <span>{subbanner.title}</span>
      </div>
      <div className="flex flex-col mx-auto mt-10 text-sm font-medium text-primary ">
